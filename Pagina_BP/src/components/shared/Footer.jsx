    ...
    <footer className="bg-gray-900 text-gray-300 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <Link to="/" className="flex items-center space-x-2 text-white mb-4">
              <Stethoscope size={32} />
              <span className="text-xl font-bold">Botica Salud</span>
            </Link>
            <p className="text-sm">
              Tu salud es nuestra prioridad. Ofrecemos productos y servicios de calidad para tu bienestar.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-700 pt-8 text-center text-sm">
          <p>&copy; {currentYear} Botica Salud. Todos los derechos reservados.</p>
          <p>Desarrollado con ❤️ por Hostinger Horizons</p>
        </div>
      </div>
    </footer>
  );
