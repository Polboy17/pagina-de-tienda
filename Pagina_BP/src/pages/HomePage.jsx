    ...
    <div className="space-y-16">
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          >
            Bienvenido a <span className="bg-gradient-to-r from-white via-gray-200 to-gray-300 bg-clip-text text-transparent">Comercial 5 Estrellas</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Tu comodidad es nuestra pasión. Descubre la ropa interior perfecta para ti y tu familia.
          </motion.p>
          <motion.div
      ...
      <section className="py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground mt-2">Descubre los beneficios de confiar en Comercial Cinco Estrellas.</p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <FeatureCard
            icon={ShoppingBag}
            title="Amplia Gama de Ropa Interior"
            description="Desde básicos cómodos hasta diseños elegantes para cada ocasión y estilo."
            delay={0.1}
          />
          <FeatureCard
            icon={Users}
            title="Atención Personalizada"
            description="Nuestro equipo está listo para ayudarte a elegir la ropa interior perfecta para ti."
            delay={0.2}
          />
          <FeatureCard
            icon={Zap}
      ...
      <section className="py-16 bg-muted rounded-xl">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <img  alt="Promoción de vitaminas" className="rounded-lg mb-4 w-full h-64 object-cover" src="https://lomecan.com/hubfs/CUIDAR%20ROPA%20INTERIOR%20PREVENIR%20INFECCION%20VAGINAL%20CANDIDIASIS.jpg" />
              <h3 className="text-xl font-semibold text-foreground mb-2">¡Siéntete cómoda y segura!</h3>
              <p className="text-foreground/80 mb-4">Aprovecha nuestras ofertas exclusivas en ropa interior para toda ocasión.</p>
            ...
            <motion.div
              ...
              className="glassmorphism-card p-6"
            >
              <img  alt="Productos de cuidado de la piel" className="rounded-lg mb-4 w-full h-64 object-cover" src="https://ae01.alicdn.com/kf/S62bdf56b99594a4c8c3a9e22baa6f5c33.jpg" />
              <h3 className="text-xl font-semibold text-foreground mb-2">¡Siéntete cómoda y segura!</h3>
              <p className="text-foreground/80 mb-4">Aprovecha nuestras ofertas exclusivas en ropa interior para toda ocasión.</p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-center gradient-text drop-shadow-md">Categorías Populares</h2>
          <p className="text-muted-foreground mb-8">Encuentra rápidamente lo que buscas.</p>
          <div className="flex justify-center gap-6 flex-wrap">
            {['Hombre', 'Mujer', 'Niñ@s'].map((category, index) => (
              <motion.div
                key={category}
                ...
                <Link to={`/products?category=${category.toLowerCase().replace(' ', '-')}`}>
                  <Card className="hover:shadow-xl transition-shadow cursor-pointer bg-gradient-to-br from-primary/10 to-secondary/10">
                    <CardContent className="p-6">
                      <p className="font-semibold text-[#d87ca0]">{category}</p>
                    </CardContent>
                  </Card>
                </Link>
              </motion.div>
